<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="ShareRegistry.aspx.cs" Inherits="ShareRegistry" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <div class="pg-opt">
        <div class="container">
            <div class="row">
                <div class="col-md-6">
                    <h2>Shareholder Registry System</h2>
                </div>
                <div class="col-md-6">
                    <ol class="breadcrumb">
                ...
                <div class="row">
                        ...
                        <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item item-dark active">
                                    <img src="images/prv/ShareRegistry.jpg" alt="" class="img-responsive">
                                </div>
                    ...
                    <div class="col-md-6">
                        <div class="vertical-info">
                            <h4>Shareholder Registry System</h4>
                            <p class="delimiter">
                        ...
                        <ul class="list-check">
                            <li><i class="fa fa-check"></i>Shareholder information</li>
                            <li><i class="fa fa-check"></i>Share detail information</li>
                            <li><i class="fa fa-check"></i>Top shareholder</li>
                            <li><i class="fa fa-check"></i>Certificate issuing</li>
                            <li><i class="fa fa-check"></i>Printed certificate info</li>
                            <li><i class="fa fa-check"></i>Dividend issuing </li>
                                    ...
                                    <div class="wp-block inverse">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <small>Share Trading System</small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
