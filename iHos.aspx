<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="iHos.aspx.cs" Inherits="iHos" %>
                ...
                <div class="row">
                        ...
                        <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item item-dark active">
                                    <img src="images/prv/riHOS.jpg" alt="" class="img-responsive">
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-check">
                            ...
                            <li><i class="fa fa-check"></i>Pharmacy item definition, service item definition with optional item codes and multiple rates feature</li>
                            <li><i class="fa fa-check"></i>Tracking patient bio data and medical history</li>
                            <li><i class="fa fa-check"></i>Identify doctor’s info & related fees</li>
                            <li><i class="fa fa-check"></i>Tracking purchase, stock in, stock out and stock transfer by daily, weekly, monthly or yearly</li>
                            <li><i class="fa fa-check"></i>Tracking and reviewing for sales, service and laboratory test in detail report </li>
                            <li><i class="fa fa-check"></i>Detail stock tracking </li>
                            ...
                            <li><i class="fa fa-check"></i>Multi-users accessing and ability to define each user with appropriate accesslevel</li>
                        </ul>
                    </div>
                </div>
            </div>
