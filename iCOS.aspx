<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="iCOS.aspx.cs" Inherits="iCOS" %>
                ...
                <div class="row">
                        ...
                        <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item item-dark active">
                                    <img src="images/prv/iCOS.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="item item-dark">
                                    <img src="images/prv/iCOSForm.jpg" alt="" class="img-responsive">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        <div class="vertical-info">
                            <h4>iCOS</h4>
                            <p class="delimiter">
                            Intelligent Construction Operating System
                            </p>
                        </div>
                        ...
                        <div class="section-title-wr mt-40">
                            ...
                            <ul class="list-check">
                                <li><i class="fa fa-check"></i>Item definition with optional item codes and offer multiple rates</li>
                                <li><i class="fa fa-check"></i>Easy identifying employee info</li>
                                <li><i class="fa fa-check"></i>Easy tracking labor contract, labor requisition and cash issue transaction </li>
                                <li><i class="fa fa-check"></i>Easy tracking site activities, site estimate, issue and return</li>
                                <li><i class="fa fa-check"></i>Estimate comparison, purchase and order comparison, requisition and order comparison</li>
                                <li><i class="fa fa-check"></i>Tracking material requisition, purchase order, purchase, stock in, stock out and stock </li>
                                <li><i class="fa fa-check"></i>Stock tracking by daily, weekly, monthly or yearly</li>
                                <li><i class="fa fa-check"></i>Provide reviewing payment and supplier outstanding</li>
                                <li><i class="fa fa-check"></i>All Reports can be printed and exported rapidly</li>
                                <li><i class="fa fa-check"></i>Available network system for multi-counter and multi-location</li>
                                <li><i class="fa fa-check"></i>Multi-users accessing and ability to define each user with appropriate access level</li>
