<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="SkatePark.aspx.cs" Inherits="SkatePark" %>
                ...
                <div class="row">
                        ...
                        <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item item-dark active">
                                    <img src="images/prv/skate.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="item item-dark">
                                    <img src="images/prv/SkateParkMainForm.jpg" alt="" class="img-responsive">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="section-title-wr mt-40">
                            ...
                            <ul class="list-check">
                                <li><i class="fa fa-check"></i>Creating Play Card</li>
                                <li><i class="fa fa-check"></i>Creating Promotion Card</li>
                                <li><i class="fa fa-check"></i>Creating Prepaid Card</li>
                                <li><i class="fa fa-check"></i>Creating Promotion Card</li>
                                <li><i class="fa fa-check"></i>Can be easily notes check in time</li>
                                <li><i class="fa fa-check"></i>Can be easily calculated played time and amount when check out time</li>
                                <li><i class="fa fa-check"></i>Can be easily viewed report by playing card and selling prepaid card</li>
                            </ul>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="wp-block inverse">
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12">
                                                ...
                                                <small>Skate Park Control Operation System</small>
                                            </div> 
                                        </div>
                                    </div>
                                </div>
