<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JAPP.aspx.cs" Inherits="JAPP" %>
                ...
                <div class="row">
                        ...
                        <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item item-dark active">
                                    <img src="images/prv/jApp.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="item item-dark">
                                    <img src="images/prv/JappMainForm.jpg" alt="" class="img-responsive">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="section-title-wr mt-40">
                            ...
                            <ul class="list-check">
                                <li><i class="fa fa-check"></i>Solution for Job Application System</li>
                                <li><i class="fa fa-check"></i>Keep applicant detail information and able to classify with Grade</li>
                                <li><i class="fa fa-check"></i>Allow employment cancelling process</li>
                                <li><i class="fa fa-check"></i>Easy to search applicant data with grade, educated, work experienced and so on</li>
                                <li><i class="fa fa-check"></i>Keep track of all record for each applicant</li>
                                <li><i class="fa fa-check"></i>Provide multiple post order for employer</li>
                                <li><i class="fa fa-check"></i>Containing list of completed order, processing order and also remaining order</li>
                                <li><i class="fa fa-check"></i>Allow applicant exchange process in order to meet with employer need</li>
                                <li><i class="fa fa-check"></i>Provide Daily, Weekly, Monthly and Yearly Work Done report</li>
