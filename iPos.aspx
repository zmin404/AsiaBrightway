<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="iPos.aspx.cs" Inherits="iPos" %>
                ...
                <div class="row">
                        ...
                        <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item item-dark active">
                                    <img src="images/prv/intelliPOS.jpg" alt="" class="img-responsive">
                                </div>
                                <div class="item item-dark">
                                    <img src="images/prv/iPOSSaleForm.jpg" alt="" class="img-responsive">
                                </div>
                            </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <ul class="list-check">
                            ...
                            <li><i class="fa fa-check"></i>Item definition with optional item codes, and offer multiple currency and rates</li>
                            <li><i class="fa fa-check"></i>Retail or whole sales</li>
                            <li><i class="fa fa-check"></i>Discount allowance can be on each item</li>
                            <li><i class="fa fa-check"></i>Tracking sales and provide sales detail report in daily, weekly, monthly or yearly</li>
                            <li><i class="fa fa-check"></i>Tracking purchase and provide purchase detail by daily, weekly, monthly or yearly</li>
                            <li><i class="fa fa-check"></i>Review both customer outstanding and supplier outstanding and also payments features</li>
                            <li><i class="fa fa-check"></i>Tracking all stock in, stock out and stock transfer in daily, weekly, monthly or yearly</li>
                            <li><i class="fa fa-check"></i>Check stock statements by category or store location</li>
                            <li><i class="fa fa-check"></i>Stock tracking in detail</li>
                            <li><i class="fa fa-check"></i>Multiusers accessing and define users with different access level</li>
                        </ul>
                    </div>
                </div>
            </div>
