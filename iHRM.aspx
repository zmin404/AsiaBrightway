<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="iHRM.aspx.cs" Inherits="iHRM" %>
                ...
                <div class="row">
                        ...
                        <div id="workCarousel" class="carousel carousel-4 slide color-two-l" data-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="item item-dark active">
                                    <img src="images/prv/IHRM.jpg" alt="" class="img-responsive">
                                </div>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="section-title-wr mt-40">
                            ...
                            <ul class="list-check">
                                <li><i class="fa fa-check"></i>Easy to accessemployee information</li>
                                <li><i class="fa fa-check"></i>View employee info in detail such as by branch, department, designation, leave or holiday</li>
                                <li><i class="fa fa-check"></i>Tracking employee attendance or leave by auto or manual</li>
                                <li><i class="fa fa-check"></i>Allowance and deduction feature</li>
                                <li><i class="fa fa-check"></i>Detail report of employee history</li>
                                <li><i class="fa fa-check"></i>Payroll for employee and tracking for every past transactions in detail</li>
                                <li><i class="fa fa-check"></i>All reports are clear and can be printed or exported rapidly</li>
                                <li><i class="fa fa-check"></i>Available network system for multi locations</li>
